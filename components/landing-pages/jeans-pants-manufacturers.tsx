...
const JeansPantsManufacturersComp: FC<ITaglineProps> = ({mainHeading, subHeading}) => {
  return (
    <div className="row">
      ...
      <div className="mb-5">
        ...
        <p className="mb-3">For over 2 years of experience dealing in manufacturing and export of high quality jeans, the company has gained popularity and trust to make it one of the leading names in the industry. Years of effort, time, practice and precision has made PK Apparel a trusted name and the number one choice.</p>
...
export default JeansPantsManufacturersComp;
