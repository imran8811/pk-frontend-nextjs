  ...
  return (
    ...
    <div className="row">
      ...
      <div className='mb-5'>
            ...
            <table className='table table-light'>
              <thead>
                <tr>
                  ...
                  <th scope='col'>Stitching Cost</th>
                  <th scope='col'>Zip Cost</th>
                  <th scope='col'>Total cost</th>
                </tr>
              </thead>
              <tbody>
        ...
        <p className='mb-3'>However, each pair of jeans and denim must be checked for quality before packaging. At this stage, every jean is individually examined to ensure its quality.</p>
        
        <h3>Packaging accessories</h3>
        <p className='mb-3'>Packaging not only entails covering, wrapping, and preparing cartons, but it also adds some packaging accessories. Packaging accessories that are common and every brand use it are listed below:</p>
        <ul className='pk-list-item'>
          <li>Labels
            <ul className='pk-list-item'>
              <li>Brand Label</li>
        ...
        <p className='mb-3'>However, packaging accessories are one of the most essential costs because packaging protects your denim until it reaches your destination. So, for every single denim, the cost of packaging accessories is about 0.10$.</p>
        <div className='row justify-content-center'>
          <div className='col-6'>
            <table className='table table-light'>
              <thead>
                <tr>
                  ...
                  <th scope='col'>Packing Material Cost</th>
                  <th scope='col'>Total cost</th>
                </tr>
              </thead>
              <tbody>
        ...
        <p className='mb-3'>So, it is essential to add these costs to the manufacturing cost of jeans. So, here, we will add overhead cost to the cost of jeans after washing.</p>
        <div className='row justify-content-center'>
          <div className='col-6'>
            <table className='table table-light'>
              <thead>
        ...
        These are the significant factors that impact the overall cost of jeans production at the factory. So, please place your order with us and get your jeans prepared by experts.</p>
      </div>
    </div>
    </div>
  )}
